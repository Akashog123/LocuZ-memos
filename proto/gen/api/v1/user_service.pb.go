...
const (
	...
	// POMODORO is the key for pomodoro timer settings.
	UserSetting_POMODORO UserSetting_Key = 5
)
...
func (x *UserSetting) GetPomodoroSetting() *UserSetting_PomodoroSetting {
	if x != nil {
		if x, ok := x.Value.(*UserSetting_PomodoroSetting_); ok {
			return x.PomodoroSetting
		}
	}
	return nil
}
...
type UserSetting_PomodoroSetting_ struct {
	PomodoroSetting *UserSetting_PomodoroSetting `protobuf:"bytes,6,opt,name=pomodoro_setting,json=pomodoroSetting,proto3,oneof"`
}
...
func (*UserSetting_PomodoroSetting_) isUserSetting_Value() {}
...
type UserSetting_PomodoroSetting struct {
	state protoimpl.MessageState `protogen:"open.v1"`
	// Selected preset ID
	...
	Presets []*UserSetting_TimerPreset `protobuf:"bytes,2,rep,name=presets,proto3" json:"presets,omitempty"`
	// Appearance settings for each mode
	AppearanceSettings *UserSetting_AppearanceSettings `protobuf:"bytes,3,opt,name=appearance_settings,json=appearanceSettings,proto3" json:"appearance_settings,omitempty"`
	unknownFields      protoimpl.UnknownFields
	sizeCache          protoimpl.SizeCache
}

func (x *UserSetting_PomodoroSetting) Reset() {
	*x = UserSetting_PomodoroSetting{}
	mi := &file_api_v1_user_service_proto_msgTypes[38]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}

func (x *UserSetting_PomodoroSetting) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*UserSetting_PomodoroSetting) ProtoMessage() {}

func (x *UserSetting_PomodoroSetting) ProtoReflect() protoreflect.Message {
	mi := &file_api_v1_user_service_proto_msgTypes[38]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use UserSetting_PomodoroSetting.ProtoReflect.Descriptor instead.
func (*UserSetting_PomodoroSetting) Descriptor() ([]byte, []int) {
	return file_api_v1_user_service_proto_rawDescGZIP(), []int{12, 4}
}

func (x *UserSetting_PomodoroSetting) GetSelectedPreset() string {
	if x != nil {
...
func (x *UserSetting_PomodoroSetting) GetPresets() []*UserSetting_TimerPreset {
	if x != nil {
		return x.Presets
	}
	return nil
...
func (x *UserSetting_PomodoroSetting) GetAppearanceSettings() *UserSetting_AppearanceSettings {
	if x != nil {
...
type UserSetting_AppearanceSettings struct {
	state protoimpl.MessageState `protogen:"open.v1"`
	// Home mode appearance settings
	Home *UserSetting_ModeAppearance `protobuf:"bytes,1,opt,name=home,proto3" json:"home,omitempty"`
	// Focus mode appearance settings
	Focus *UserSetting_ModeAppearance `protobuf:"bytes,2,opt,name=focus,proto3" json:"focus,omitempty"`
	// Ambient mode appearance settings
	Ambient       *UserSetting_ModeAppearance `protobuf:"bytes,3,opt,name=ambient,proto3" json:"ambient,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}

func (x *UserSetting_AppearanceSettings) Reset() {
	*x = UserSetting_AppearanceSettings{}
	mi := &file_api_v1_user_service_proto_msgTypes[39]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}

func (x *UserSetting_AppearanceSettings) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*UserSetting_AppearanceSettings) ProtoMessage() {}

func (x *UserSetting_AppearanceSettings) ProtoReflect() protoreflect.Message {
	mi := &file_api_v1_user_service_proto_msgTypes[39]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use UserSetting_AppearanceSettings.ProtoReflect.Descriptor instead.
func (*UserSetting_AppearanceSettings) Descriptor() ([]byte, []int) {
	return file_api_v1_user_service_proto_rawDescGZIP(), []int{12, 5}
}

func (x *UserSetting_AppearanceSettings) GetHome() *UserSetting_ModeAppearance {
	if x != nil {
		return x.Home
	}
	return nil
...
func (x *UserSetting_AppearanceSettings) GetFocus() *UserSetting_ModeAppearance {
	if x != nil {
		return x.Focus
	}
	return nil
...
func (x *UserSetting_AppearanceSettings) GetAmbient() *UserSetting_ModeAppearance {
	if x != nil {
		return x.Ambient
	}
	return nil
...
type UserSetting_ModeAppearance struct {
	state protoimpl.MessageState `protogen:"open.v1"`
	// Wallpaper settings
	Wallpaper *UserSetting_WallpaperSetting `protobuf:"bytes,1,opt,name=wallpaper,proto3" json:"wallpaper,omitempty"`
	// Font settings
	Font          *UserSetting_FontSetting `protobuf:"bytes,2,opt,name=font,proto3" json:"font,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}

func (x *UserSetting_ModeAppearance) Reset() {
	*x = UserSetting_ModeAppearance{}
	mi := &file_api_v1_user_service_proto_msgTypes[40]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}

func (x *UserSetting_ModeAppearance) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*UserSetting_ModeAppearance) ProtoMessage() {}

func (x *UserSetting_ModeAppearance) ProtoReflect() protoreflect.Message {
	mi := &file_api_v1_user_service_proto_msgTypes[40]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use UserSetting_ModeAppearance.ProtoReflect.Descriptor instead.
func (*UserSetting_ModeAppearance) Descriptor() ([]byte, []int) {
	return file_api_v1_user_service_proto_rawDescGZIP(), []int{12, 6}
}

func (x *UserSetting_ModeAppearance) GetWallpaper() *UserSetting_WallpaperSetting {
	if x != nil {
		return x.Wallpaper
	}
	return nil
...
func (x *UserSetting_ModeAppearance) GetFont() *UserSetting_FontSetting {
	if x != nil {
		return x.Font
	}
	return nil
...
type UserSetting_WallpaperSetting struct {
	state protoimpl.MessageState `protogen:"open.v1"`
...
func (x *UserSetting_WallpaperSetting) Reset() {
	*x = UserSetting_WallpaperSetting{}
	mi := &file_api_v1_user_service_proto_msgTypes[41]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}

func (x *UserSetting_WallpaperSetting) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*UserSetting_WallpaperSetting) ProtoMessage() {}

func (x *UserSetting_WallpaperSetting) ProtoReflect() protoreflect.Message {
	mi := &file_api_v1_user_service_proto_msgTypes[41]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use UserSetting_WallpaperSetting.ProtoReflect.Descriptor instead.
func (*UserSetting_WallpaperSetting) Descriptor() ([]byte, []int) {
	return file_api_v1_user_service_proto_rawDescGZIP(), []int{12, 7}
}

func (x *UserSetting_WallpaperSetting) GetSelectedWallpaper() string {
	if x != nil {
...
func (x *UserSetting_WallpaperSetting) GetWallpaperStyle() string {
	if x != nil {
...
// Font configuration
type UserSetting_FontSetting struct {
	state protoimpl.MessageState `protogen:"open.v1"`
...
func (x *UserSetting_FontSetting) Reset() {
	*x = UserSetting_FontSetting{}
	mi := &file_api_v1_user_service_proto_msgTypes[42]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}

func (x *UserSetting_FontSetting) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*UserSetting_FontSetting) ProtoMessage() {}

func (x *UserSetting_FontSetting) ProtoReflect() protoreflect.Message {
	mi := &file_api_v1_user_service_proto_msgTypes[42]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use UserSetting_FontSetting.ProtoReflect.Descriptor instead.
func (*UserSetting_FontSetting) Descriptor() ([]byte, []int) {
	return file_api_v1_user_service_proto_rawDescGZIP(), []int{12, 8}
}

func (x *UserSetting_FontSetting) GetSelectedFont() string {
	if x != nil {
...
func (x *UserSetting_FontSetting) GetFontSize() int32 {
	if x != nil {
		return x.FontSize
	}
	return 0
...
func (x *UserSetting_FontSetting) GetFontColor() string {
	if x != nil {
		return x.FontColor
	}
	return ""
...
type UserSetting_TimerPreset struct {
	state protoimpl.MessageState `protogen:"open.v1"`
...
func (x *UserSetting_TimerPreset) Reset() {
	*x = UserSetting_TimerPreset{}
	mi := &file_api_v1_user_service_proto_msgTypes[43]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}

func (x *UserSetting_TimerPreset) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*UserSetting_TimerPreset) ProtoMessage() {}

func (x *UserSetting_TimerPreset) ProtoReflect() protoreflect.Message {
	mi := &file_api_v1_user_service_proto_msgTypes[43]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use UserSetting_TimerPreset.ProtoReflect.Descriptor instead.
func (*UserSetting_TimerPreset) Descriptor() ([]byte, []int) {
	return file_api_v1_user_service_proto_rawDescGZIP(), []int{12, 9}
}

func (x *UserSetting_TimerPreset) GetId() string {
	if x != nil {
		return x.Id
	}
	return ""
...
func (x *UserSetting_TimerPreset) GetName() string {
	if x != nil {
		return x.Name
	}
	return ""
...
func (x *UserSetting_TimerPreset) GetDescription() string {
	if x != nil {
		return x.Description
	}
	return ""
...
func (x *UserSetting_TimerPreset) GetType() string {
	if x != nil {
		return x.Type
	}
	return ""
...
func (x *UserSetting_TimerPreset) GetFocusDuration() int32 {
	if x != nil {
...
func (x *UserSetting_TimerPreset) GetShortBreakDuration() int32 {
	if x != nil {
...
func (x *UserSetting_TimerPreset) GetLongBreakDuration() int32 {
	if x != nil {
...
func (x *UserSetting_TimerPreset) GetLongBreakInterval() int32 {
	if x != nil {
...
func (x *UserSetting_TimerPreset) GetAutoStartBreaks() bool {
	if x != nil {
...
func (x *UserSetting_TimerPreset) GetAutoStartFocus() bool {
	if x != nil {
...
func (x *UserSetting_TimerPreset) GetIsDefault() bool {
	if x != nil {
		return x.IsDefault
	}
	return false
...
const file_api_v1_user_service_proto_rawDesc = "" +
	...
	"\x05stats\x18\x01 \x03(\v2\x17.memos.api.v1.UserStatsR\x05stats\"\xdb\x11\n" +
	...
	"\x10webhooks_setting\x18\x05 \x01(\v2).memos.api.v1.UserSetting.WebhooksSettingH\x00R\x0fwebhooksSetting\x12V\n" +
	"\x10pomodoro_setting\x18\x06 \x01(\v2).memos.api.v1.UserSetting.PomodoroSettingH\x00R\x0fpomodoroSetting\x1av\n" +
	...
	"\bwebhooks\x18\x01 \x03(\v2\x19.memos.api.v1.UserWebhookR\bwebhooks\x1a\xda\x01\n" +
	"\x0fPomodoroSetting\x12'\n" +
	"\x0fselected_preset\x18\x01 \x01(\tR\x0eselectedPreset\x12?\n" +
	"\apresets\x18\x02 \x03(\v2%.memos.api.v1.UserSetting.TimerPresetR\apresets\x12]\n" +
	"\x13appearance_settings\x18\x03 \x01(\v2,.memos.api.v1.UserSetting.AppearanceSettingsR\x12appearanceSettings\x1a\xd6\x01\n" +
	"\x12AppearanceSettings\x12<\n" +
	"\x04home\x18\x01 \x01(\v2(.memos.api.v1.UserSetting.ModeAppearanceR\x04home\x12>\n" +
	"\x05focus\x18\x02 \x01(\v2(.memos.api.v1.UserSetting.ModeAppearanceR\x05focus\x12B\n" +
	"\aambient\x18\x03 \x01(\v2(.memos.api.v1.UserSetting.ModeAppearanceR\aambient\x1a\x95\x01\n" +
	"\x0eModeAppearance\x12H\n" +
	"\twallpaper\x18\x01 \x01(\v2*.memos.api.v1.UserSetting.WallpaperSettingR\twallpaper\x129\n" +
	"\x04font\x18\x02 \x01(\v2%.memos.api.v1.UserSetting.FontSettingR\x04font\x1aj\n" +
	"\x10WallpaperSetting\x12-\n" +
	"\x12selected_wallpaper\x18\x01 \x01(\tR\x11selectedWallpaper\x12'\n" +
	"\x0fwallpaper_style\x18\x02 \x01(\tR\x0ewallpaperStyle\x1an\n" +
	"\vFontSetting\x12#\n" +
	"\rselected_font\x18\x01 \x01(\tR\fselectedFont\x12\x1b\n" +
	"\tfont_size\x18\x02 \x01(\x05R\bfontSize\x12\x1d\n" +
	"\n" +
	"font_color\x18\x03 \x01(\tR\tfontColor\x1a\x95\x03\n" +
	...
	"\n" +
	"is_default\x18\v \x01(\bR\tisDefault\"d\n" +
	"\x03Key\x12\x13\n" +
	"\x0fKEY_UNSPECIFIED\x10\x00\x12\v\n" +
	"\aGENERAL\x10\x01\x12\f\n" +
	"\bSESSIONS\x10\x02\x12\x11\n" +
	"\rACCESS_TOKENS\x10\x03\x12\f\n" +
	"\bWEBHOOKS\x10\x04\x12\f\n" +
	"\bPOMODORO\x10\x05:Y\xeaAV\n" +
...
var file_api_v1_user_service_proto_msgTypes = make([]protoimpl.MessageInfo, 45)
var file_api_v1_user_service_proto_goTypes = []any{
	...
	(*UserSetting_PomodoroSetting)(nil),     // 40: memos.api.v1.UserSetting.PomodoroSetting
	(*UserSetting_AppearanceSettings)(nil),  // 41: memos.api.v1.UserSetting.AppearanceSettings
	(*UserSetting_ModeAppearance)(nil),      // 42: memos.api.v1.UserSetting.ModeAppearance
	(*UserSetting_WallpaperSetting)(nil),    // 43: memos.api.v1.UserSetting.WallpaperSetting
	(*UserSetting_FontSetting)(nil),         // 44: memos.api.v1.UserSetting.FontSetting
	(*UserSetting_TimerPreset)(nil),         // 45: memos.api.v1.UserSetting.TimerPreset
...
var file_api_v1_user_service_proto_depIdxs = []int32{
	...
	40, // 17: memos.api.v1.UserSetting.pomodoro_setting:type_name -> memos.api.v1.UserSetting.PomodoroSetting
	14, // 18: memos.api.v1.UpdateUserSettingRequest.setting:type_name -> memos.api.v1.UserSetting
	49, // 19: memos.api.v1.UpdateUserSettingRequest.update_mask:type_name -> google.protobuf.FieldMask
	14, // 20: memos.api.v1.ListUserSettingsResponse.settings:type_name -> memos.api.v1.UserSetting
	48, // 21: memos.api.v1.UserAccessToken.issued_at:type_name -> google.protobuf.Timestamp
	48, // 22: memos.api.v1.UserAccessToken.expires_at:type_name -> google.protobuf.Timestamp
	...
	48, // 25: memos.api.v1.UserSession.create_time:type_name -> google.protobuf.Timestamp
	48, // 26: memos.api.v1.UserSession.last_accessed_time:type_name -> google.protobuf.Timestamp
	46, // 27: memos.api.v1.UserSession.client_info:type_name -> memos.api.v1.UserSession.ClientInfo
	24, // 28: memos.api.v1.ListUserSessionsResponse.sessions:type_name -> memos.api.v1.UserSession
	48, // 29: memos.api.v1.UserWebhook.create_time:type_name -> google.protobuf.Timestamp
	48, // 30: memos.api.v1.UserWebhook.update_time:type_name -> google.protobuf.Timestamp
	...
	49, // 34: memos.api.v1.UpdateUserWebhookRequest.update_mask:type_name -> google.protobuf.FieldMask
	...
	45, // 38: memos.api.v1.UserSetting.PomodoroSetting.presets:type_name -> memos.api.v1.UserSetting.TimerPreset
	41, // 39: memos.api.v1.UserSetting.PomodoroSetting.appearance_settings:type_name -> memos.api.v1.UserSetting.AppearanceSettings
	42, // 40: memos.api.v1.UserSetting.AppearanceSettings.home:type_name -> memos.api.v1.UserSetting.ModeAppearance
	42, // 41: memos.api.v1.UserSetting.AppearanceSettings.focus:type_name -> memos.api.v1.UserSetting.ModeAppearance
	42, // 42: memos.api.v1.UserSetting.AppearanceSettings.ambient:type_name -> memos.api.v1.UserSetting.ModeAppearance
	43, // 43: memos.api.v1.UserSetting.ModeAppearance.wallpaper:type_name -> memos.api.v1.UserSetting.WallpaperSetting
	44, // 44: memos.api.v1.UserSetting.ModeAppearance.font:type_name -> memos.api.v1.UserSetting.FontSetting
	3,  // 45: memos.api.v1.UserService.ListUsers:input_type -> memos.api.v1.ListUsersRequest
	5,  // 46: memos.api.v1.UserService.GetUser:input_type -> memos.api.v1.GetUserRequest
	6,  // 47: memos.api.v1.UserService.CreateUser:input_type -> memos.api.v1.CreateUserRequest
	7,  // 48: memos.api.v1.UserService.UpdateUser:input_type -> memos.api.v1.UpdateUserRequest
	8,  // 49: memos.api.v1.UserService.DeleteUser:input_type -> memos.api.v1.DeleteUserRequest
	9,  // 50: memos.api.v1.UserService.GetUserAvatar:input_type -> memos.api.v1.GetUserAvatarRequest
	12, // 51: memos.api.v1.UserService.ListAllUserStats:input_type -> memos.api.v1.ListAllUserStatsRequest
	11, // 52: memos.api.v1.UserService.GetUserStats:input_type -> memos.api.v1.GetUserStatsRequest
	15, // 53: memos.api.v1.UserService.GetUserSetting:input_type -> memos.api.v1.GetUserSettingRequest
	16, // 54: memos.api.v1.UserService.UpdateUserSetting:input_type -> memos.api.v1.UpdateUserSettingRequest
	17, // 55: memos.api.v1.UserService.ListUserSettings:input_type -> memos.api.v1.ListUserSettingsRequest
	20, // 56: memos.api.v1.UserService.ListUserAccessTokens:input_type -> memos.api.v1.ListUserAccessTokensRequest
	22, // 57: memos.api.v1.UserService.CreateUserAccessToken:input_type -> memos.api.v1.CreateUserAccessTokenRequest
	23, // 58: memos.api.v1.UserService.DeleteUserAccessToken:input_type -> memos.api.v1.DeleteUserAccessTokenRequest
	25, // 59: memos.api.v1.UserService.ListUserSessions:input_type -> memos.api.v1.ListUserSessionsRequest
	27, // 60: memos.api.v1.UserService.RevokeUserSession:input_type -> memos.api.v1.RevokeUserSessionRequest
	29, // 61: memos.api.v1.UserService.ListUserWebhooks:input_type -> memos.api.v1.ListUserWebhooksRequest
	31, // 62: memos.api.v1.UserService.CreateUserWebhook:input_type -> memos.api.v1.CreateUserWebhookRequest
	32, // 63: memos.api.v1.UserService.UpdateUserWebhook:input_type -> memos.api.v1.UpdateUserWebhookRequest
	33, // 64: memos.api.v1.UserService.DeleteUserWebhook:input_type -> memos.api.v1.DeleteUserWebhookRequest
	4,  // 65: memos.api.v1.UserService.ListUsers:output_type -> memos.api.v1.ListUsersResponse
	2,  // 66: memos.api.v1.UserService.GetUser:output_type -> memos.api.v1.User
	2,  // 67: memos.api.v1.UserService.CreateUser:output_type -> memos.api.v1.User
	2,  // 68: memos.api.v1.UserService.UpdateUser:output_type -> memos.api.v1.User
	50, // 69: memos.api.v1.UserService.DeleteUser:output_type -> google.protobuf.Empty
	51, // 70: memos.api.v1.UserService.GetUserAvatar:output_type -> google.api.HttpBody
	13, // 71: memos.api.v1.UserService.ListAllUserStats:output_type -> memos.api.v1.ListAllUserStatsResponse
	10, // 72: memos.api.v1.UserService.GetUserStats:output_type -> memos.api.v1.UserStats
	14, // 73: memos.api.v1.UserService.GetUserSetting:output_type -> memos.api.v1.UserSetting
	14, // 74: memos.api.v1.UserService.UpdateUserSetting:output_type -> memos.api.v1.UserSetting
	18, // 75: memos.api.v1.UserService.ListUserSettings:output_type -> memos.api.v1.ListUserSettingsResponse
	21, // 76: memos.api.v1.UserService.ListUserAccessTokens:output_type -> memos.api.v1.ListUserAccessTokensResponse
	19, // 77: memos.api.v1.UserService.CreateUserAccessToken:output_type -> memos.api.v1.UserAccessToken
	50, // 78: memos.api.v1.UserService.DeleteUserAccessToken:output_type -> google.protobuf.Empty
	26, // 79: memos.api.v1.UserService.ListUserSessions:output_type -> memos.api.v1.ListUserSessionsResponse
	50, // 80: memos.api.v1.UserService.RevokeUserSession:output_type -> google.protobuf.Empty
	30, // 81: memos.api.v1.UserService.ListUserWebhooks:output_type -> memos.api.v1.ListUserWebhooksResponse
	28, // 82: memos.api.v1.UserService.CreateUserWebhook:output_type -> memos.api.v1.UserWebhook
	28, // 83: memos.api.v1.UserService.UpdateUserWebhook:output_type -> memos.api.v1.UserWebhook
	50, // 84: memos.api.v1.UserService.DeleteUserWebhook:output_type -> google.protobuf.Empty
...
func file_api_v1_user_service_proto_init() {
	...
	file_api_v1_user_service_proto_msgTypes[12].OneofWrappers = []any{
		...
		(*UserSetting_PomodoroSetting_)(nil),
	}
	type x struct{}
